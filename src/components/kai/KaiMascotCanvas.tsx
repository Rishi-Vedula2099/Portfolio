...
export default function KaiMascotCanvas({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      ctx.lineWidth = 1;
      ctx.beginPath();
      ctx.roundRect(centerX - 36, baseBodyY - 4 + leftArmWave, 8, 22, 4);
      ctx.fill();
      ctx.stroke();

      // Right Arm
      ctx.beginPath();
      ctx.roundRect(centerX + 28, baseBodyY - 4 + rightArmWave, 8, 22, 4);
      ctx.fill();
      ctx.stroke();
      ...
      ctx.lineWidth = 1.2;
      ctx.beginPath();
      ctx.roundRect(centerX - 24, baseBodyY - 12, 48, 44, 12);
      ctx.fill();
      ctx.stroke();
      ...
      ctx.beginPath();
      ctx.roundRect(centerX - 6, baseHeadY + 20, 12, 8, 3);
      ctx.fill();
      ...
      ctx.lineWidth = 1.5;
      ctx.beginPath();
      ctx.roundRect(centerX - 30, baseHeadY - 24, 60, 46, 14);
      ctx.fill();
      ctx.stroke();
      ...
      ctx.beginPath();
      ctx.roundRect(centerX - 24, baseHeadY - 18, 48, 34, 8);
      ctx.fill();
      ...
      if (mascotState === "talking" || audioAmplitude > 0) {
        ...
        for (let i = 0; i < bars; i++) {
          ...
          ctx.beginPath();
          ctx.roundRect(startX + i * (barWidth + 2), baseHeadY + 6 - h / 2, barWidth, h, 1);
          ctx.fill();
        }
